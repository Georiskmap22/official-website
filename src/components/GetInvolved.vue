...
<template>
    <div class="h-auto">
      ...
      <transition name="fade">
        <div id="overlay" class="fixed top-0 backdrop-blur-sm bg-[rgba(0,0,0,0.5)] w-screen h-[100vh] transition z-[99] grid place-items-center" v-if="isOpen">
          <Spinner v-if="isLoading"/>
          <form id="myForm" class=" bg-white w-[70%] tab:w-[90%] mx-auto  h-auto rounded-[0.5rem] z-[999] p-6" v-else @submit.prevent="sendMail">
